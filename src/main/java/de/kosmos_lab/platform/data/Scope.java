...
/**
 * The representation of a scope. A Scope is used to optionally restrict the access to a device to specific users. There
 * are two levels of access: - user can access the device/function locked behind a scope - admin can additionally manage
 * the users of a scope
 */
public class Scope {
