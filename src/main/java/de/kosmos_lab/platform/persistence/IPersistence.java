...
public interface IPersistence {
     ...
     */
    @Nonnull
    Group getGroup(@Nonnull String name) throws NotFoundInPersistenceException;
     ...
     */
    @Nonnull
    Group getGroup(int id) throws NotFoundInPersistenceException;
     ...
     */
    @Nonnull
    JSONObject getLastState(@Nonnull String uuid);
     ...
     */
    @Nonnull
    List<LogEntry> getStates(long from, long to, @Nonnull String[] uuids);
     ...
     */
    @Nonnull
    List<LogEntry> getStates(long from, long to, @Nonnull Set<String> uuids);
     ...
     */
    @Nonnull
    Collection<DataSchema> initSchema();
