...
public class ScopeAddAdminGroupServlet extends KosmoSAuthedServlet {

    private static final String FIELD_GROUP = "group";
    private static final String FIELD_SCOPE = "scope";

    public ScopeAddAdminGroupServlet(KosmoSWebServer webServer, IController controller, int level) {
    ...
    @Operation(
            ...
            description = "add a new group as an admin to a scope",
