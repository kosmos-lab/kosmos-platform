...
@WebServlet(urlPatterns = {"/group/adduser"}, loadOnStartup = 1)
public class GroupAddUserServlet extends AuthedServlet {
    
    
    public GroupAddUserServlet(WebServer webServer, IController controller) {
        super(webServer, controller);
    }
    
    public void post(KosmoSHttpServletRequest request, HttpServletResponse response)
        
            throws ServletException, IOException, NotObjectSchemaException, NoAccessToGroup, NotFoundInPersistenceException, NotFoundException, ParameterNotFoundException {
