...
@WebServlet(urlPatterns = {"/scope/deluser"}, loadOnStartup = 1)
public class ScopeDelUserServlet extends AuthedServlet {
    
    
    public ScopeDelUserServlet(WebServer webServer, IController controller) {
