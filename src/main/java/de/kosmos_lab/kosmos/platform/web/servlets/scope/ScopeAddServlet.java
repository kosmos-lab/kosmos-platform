...
public class ScopeAddServlet extends AuthedServlet {
    ...
    @Operation(
            ...
            responses = {
                    ...
                    @ApiResponse(responseCode = @ResponseCode(statusCode = KosmoSServlet.STATUS_OK),ref = "#/components/responses/scopeGet",description = "The scope was added successfully"),
