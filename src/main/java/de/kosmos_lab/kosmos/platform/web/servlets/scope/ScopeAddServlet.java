...
public class ScopeAddServlet extends AuthedServlet {
    ...
    @Operation(
            ...
            responses = {
                    ...
                    @ApiResponse(responseCode = @ResponseCode(statusCode = de.dfki.baall.helper.webserver.WebServer.STATUS_OK),ref = "#/components/responses/scopeGet",description = "The scope was added successfully"),
                    @ApiResponse(responseCode = @ResponseCode(statusCode = de.dfki.baall.helper.webserver.WebServer.STATUS_CONFLICT), description = "There is already a scope with that name."),
