...
public class TestGroup {
    ...
    private boolean checkMyAccessTo(KosmoSClient client, String name, MyListType type, MyAccessType access) {
        ...
        Assert.assertEquals(response.getStatus(), 200, "list my groups failed!");
    ...
    public void testGroupDevices() {
        ...
        Assert.assertNotNull(response);
        Assert.assertEquals(response.getStatus(), 204, "addgroupuser did fail!");
    ...
    public void testGroups() {
        ...
        Assert.assertNotNull(response);
        Assert.assertEquals(response.getStatus(), 403, "was able to hijack user adding");
        assertNotUserInGroup(CommonBase.clientUser2, testGroupsGroupName);
        ...
        Assert.assertNotNull(response);
        Assert.assertEquals(response.getStatus(), 404, "group that should not exist was found");
        ...
        Assert.assertNotNull(response);
        Assert.assertEquals(response.getStatus(), 404, "user that should not exist was found");
        ...
        Assert.assertNotNull(response);
        Assert.assertEquals(response.getStatus(), 204, "could not add user to group?");
        assertNotAdminInGroup(CommonBase.clientUser2, testGroupsGroupName);
        ...
        Assert.assertNotNull(response);
        Assert.assertEquals(response.getStatus(), 204, "could not del admin from group?");
        assertNotAdminInGroup(CommonBase.clientUser, testGroupsGroupName);
        assertNotUserInGroup(CommonBase.clientUser, testGroupsGroupName);
        ...
        Assert.assertNotNull(response);
        Assert.assertEquals(response.getStatus(), 204, "could not delete group?");
        response = CommonBase.clientUser3.getResponse("/group/get", HttpMethod.GET,new JSONObject().put("name", testGroupsGroupName));
        Assert.assertNotNull(response);

        Assert.assertEquals(response.getStatus(), 404, "could find deleted group again");
